...
public class MercedesParserTest {

    private final MercedesParser mercedesParser = new MercedesParser();

    @Test
    void extractCarsModelsTest() throws IOException {
        List<CarWithImageSource> extractedCarsModels = mercedesParser.extractCarsModels(
            "https://www.mercedes-benz.com.cn/api/global-data?fields=header"
        );
